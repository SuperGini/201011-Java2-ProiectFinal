...
public class ServiceOrderController implements ServiceOrderService {
    ...
    @Override
    public ServiceOrderDto getPartsAndCarProblems(int id) {
        try {
           return serviceOrderService.getPartsAndCarProblems(id);
        } catch (RemoteException e) {
            e.printStackTrace();
            throw new RuntimeException(e);
        }
    ...
    @Override
    public ServiceOrderDto getParts(int id){
        try {
           return serviceOrderService.getParts(id);
        } catch (RemoteException e) {
            e.printStackTrace();
            throw new RuntimeException(e);
        }
